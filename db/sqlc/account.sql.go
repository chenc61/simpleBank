...
UPDATE account SET balance = balance + $1 WHERE id = $2 RETURNING id, owner, balance, currency, created_at
`
...
SELECT id, owner, balance, currency, created_at FROM account WHERE id = $1 LIMIT 1 FOR NO KEY UPDATE
`
